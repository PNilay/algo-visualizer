...
export class WalkthrouhTutorialComponent implements OnInit {
  ...
  <div class="text-medium-light subtitle-padding">
    Color in grid represents type of Node/Block. Here are the mapping of each color with it\'s portrayal.
    ...
    onTouch(){
      if(this.touch_btn_val == "For Touch Devices"){
        ...
        if(this.walkthrough_steps[this.walkthrough_page]['title'] == "Wall Blocks"){
          this.walkthrough_steps[this.walkthrough_page]['body'] = this.wall_block_touch;
          this.touch_btn_val = "For Click Devices";
        }else{
          this.walkthrough_steps[this.walkthrough_page]['body'] = this.toll_block_touch;
          this.touch_btn_val = "For Click Devices";
        }
      }else{
        if(this.walkthrough_steps[this.walkthrough_page]['title'] == "Wall Blocks"){
          this.walkthrough_steps[this.walkthrough_page]['body'] = this.wall_block_click;
          this.touch_btn_val = "For Touch Devices";
        }else{
          this.walkthrough_steps[this.walkthrough_page]['body'] = this.toll_block_click;
          this.touch_btn_val = "For Touch Devices";
        }
      }
